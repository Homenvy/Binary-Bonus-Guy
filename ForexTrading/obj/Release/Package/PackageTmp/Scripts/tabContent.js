var tabs = function () {
    ...
    var a = [], i = function (d) {
        ...
        if (document.addEventListener)
            ...
            document.attachEvent("onreadystatechange", function () { document.readyState === "complete" && a() })
        }
    ...
    i(f);
    return {
        open: function (c, d) { for (var b = 0; b < a.length; b++) a[b].n(c, d) }
    }
}()